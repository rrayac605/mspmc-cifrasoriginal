package mx.gob.imss.cit.mspmccifrascontrol.security.service;
...
import mx.gob.imss.cit.mspmccifrascontrol.security.model.TokenInfoModel;
	...
	public ResponseEntity<TokenInfoModel> validateToken(HttpServletRequest request) {
		...
		try {
			...
			if(urlTokenInfo.isPresent()) {
				tokenInfo = urlTokenInfo.get().getDesParametro();
			}
